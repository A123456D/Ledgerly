  ...
  if (src) {
    return (
      ...
      <img
        src={src}
        alt=""
        className={`shrink-0 ${className} ${rounded} object-contain ${invert ? "brightness-0 invert" : ""}`}
      />
    );
  }
  return (
    <div
      className={`flex shrink-0 items-center justify-center text-3xl font-bold text-white ${rounded} ${className}`}
    ...
    <Sheet className="bg-[#fffdf9] text-[#1c1917] font-[family-name:var(--font-body)]">
      ...
      <div className="relative flex min-w-0 items-start justify-between gap-6">
        <div className="flex min-w-0 flex-1 items-center gap-5">
          <Logo src={logo} name={doc.business.name} accent={accent} className="h-40 w-40" />
  ...
  return (
    <Sheet className="bg-white text-[#111] font-[family-name:var(--font-body)]">
      <div className="flex items-end justify-between border-b border-neutral-200 pb-10">
        <div>
          <Logo src={logo} name={doc.business.name} accent={accent} className="mb-8 h-36 w-auto max-w-[320px] rounded-none" />
    ...
    <Sheet bleed className="bg-white text-[#0f172a] font-[family-name:var(--font-body)]">
      <div className="grid min-h-[297mm] grid-cols-[0.38fr_0.62fr]">
        <div className="relative flex flex-col justify-between p-8 text-white" style={{ background: accent }}>
          ...
          <div>
            <Logo src={logo} name={doc.business.name} accent="#fff" className="h-36 w-36" invert={!!logo} rounded="rounded-2xl" />
  ...
  return (
    <Sheet className="bg-[#faf6f0] text-[#2a211c] font-[family-name:var(--font-display)]">
      <div className="text-center">
        <div className="mx-auto flex h-40 w-40 items-center justify-center rounded-full ring-1 ring-black/10" style={{ background: `${accent}18` }}>
          <Logo src={logo} name={doc.business.name} accent={accent} className="h-32 w-32 rounded-full" />
        </div>
      ...
      <div className="px-10 py-7 text-white" style={{ background: accent }}>
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <Logo src={logo} name={doc.business.name} accent="#fff" className="h-36 w-36" invert={!!logo} />
  ...
  return (
    <Sheet className="bg-[#070b16] text-[#e8eefc] font-[family-name:var(--font-body)]">
      ...
      <div className="relative flex items-start justify-between gap-6">
        <div>
          <Logo src={logo} name={doc.business.name} accent={accent} className="h-36 w-auto max-w-[320px]" />
    ...
    <Sheet className="bg-[#fff5f7] text-[#1c1917] font-[family-name:var(--font-display)]">
      ...
      <div className="relative overflow-hidden rounded-[28px] bg-white shadow-[0_20px_50px_rgba(225,29,72,0.08)] ring-1 ring-rose-100">
        <div className="flex items-center justify-between gap-4 px-7 py-6" style={{ background: `linear-gradient(120deg, ${accent}18, #fda4af33)` }}>
          <div className="flex items-center gap-3">
            <Logo src={logo} name={doc.business.name} accent={accent} className="h-36 w-36" rounded="rounded-2xl" />
            <div>
        ...
        <div className="invoice-pad">
          <div className="flex items-start justify-between gap-6">
            <div className="flex gap-3">
              <Logo src={logo} name={doc.business.name} accent={accent} className="h-36 w-36" rounded="rounded-md" />
              <div>
  ...
  return (
    <Sheet className="bg-[#eef5ea] text-[#1f2a22] font-[family-name:var(--font-display)]">
      ...
      <div className="relative flex items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <Logo src={logo} name={doc.business.name} accent={accent} className="h-36 w-36" rounded="rounded-full" />
          <div>
  ...
  return (
    <Sheet className="bg-white text-black font-[family-name:var(--font-display)]">
      ...
      <div className="relative">
        ...
        <div className="flex items-start justify-between gap-6">
          <div>
            <Logo src={logo} name={doc.business.name} accent={accent} className="h-36 w-36" rounded="rounded-none" />
    ...
    <Sheet bleed className="bg-[#fafaf9] text-[#1c1917] font-[family-name:var(--font-body)]">
      ...
      >
        ...
        <div className="relative flex items-start justify-between gap-4">
          <div>
            <Logo src={logo} name={doc.business.name} accent="#fff" className="h-36 w-auto max-w-[320px]" invert={!!logo} />
        ...
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="rounded-xl bg-white/10 p-2">
              <Logo src={logo} name={doc.business.name} accent={brass} className="h-32 w-32" invert={!!logo} />
            </div>
            <div>
  ...
  return (
    <Sheet className="bg-[#f2e6d0] text-[#3f2a1d] font-[family-name:var(--font-display)]">
      ...
      <div className="relative">
        <div className="flex items-start justify-between gap-6">
          <div className="flex gap-3">
            <Logo src={logo} name={doc.business.name} accent={accent} className="h-36 w-36" rounded="rounded-sm" />
            <div>
      ...
      <div className="invoice-pad bg-white">
        <div className="mb-4 flex items-start justify-between gap-4">
          <Logo
            ...
            accent={useAccent}
            className="h-36 w-auto max-w-[320px]"
          />
